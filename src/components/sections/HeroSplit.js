              ...
              <div className="split-item">
                <div className="hero-content split-item-content center-content-mobile reveal-from-top">
                  <h1 className="mt-0 mb-16">
                    Professional Photo Editing Made <span style={{color: 'blue'}}>Simple</span> with <span style={{color: 'red'}}>AI</span>.
                  </h1>
                  <p className="mt-0 mb-32">
                    Aipict leverages cutting-edge artificial intelligence to provide users with fast, precise, and high-quality photo editing.
                  </p>
                  <ButtonGroup>
